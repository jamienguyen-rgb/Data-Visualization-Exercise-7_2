...
st.header("5) Wind vs Temperature")
st.write("We wish to see if there's any relationship between wind and temperature: are the coolest days the windiest?")
st.altair_chart(explain_wind_vs_temp(df), use_container_width=True)
st.caption("Takeaway: There is not a strong relationship between wind and temperature. Temperature cannot be predicted by wind alone, indicating that other factors must be investigated to accurately and reliably predict temperature.")
